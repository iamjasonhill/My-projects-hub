...
# 8. PHPStan Static Analysis - DISABLED (too slow for pre-commit)
echo -e "${BLUE}8. PHPStan check skipped (run in CI/CD and deployment)${NC}"
echo -e "  ${YELLOW}ℹ️  PHPStan runs automatically in GitHub Actions and before deployment${NC}"
